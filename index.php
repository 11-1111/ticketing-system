...
<body>
    ...
    <header>
        <nav>
        <div>
    <a href="#" class="nav-item nav-logo" style="color: #ffc61a;">GARICHAPCHAP</a>
    ...
    <section id="home">
        <div id="route-search-form">
            <h1>GariChapChap Booking System</h1>

            <p class="text-center">Welcome to GariChapChap Booking System. Login now to manage bus tickets.</p>
            

<center>
    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#loginModal" style="background-color: #ffc61a; border-color: #ffc61a;">Administrator Login</button>
</center>
    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                    HELLO ADMIN, we are an online bus booking system dedicated to making your work easy,seamless and effiecient.
                </p>
            </div>
        </section>
        <section id="contact">
            <div id="contact-form">
                ...
                <form action="">
                    ...
                    <div>
                        ...
                        <textarea name="message" id="message" cols="10" rows="5"class="box"></textarea>
                    </div>
                    <div></div>
                </form>
            </div>
        ...
        <footer>
        <p>
                         <?php echo date('Y');?> - GariChapChap Booking System | Made By Ivy
                        </p>
        </footer>
    </div>
