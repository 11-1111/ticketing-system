            ...
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if(!$bus_exists)
                {
                    ...
                    $sql = "INSERT INTO `buses` (`bus_no`,`engine_no`,`model` ,`bus_created`) VALUES ('$busno','$eno','$mno', current_timestamp());";
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addBusForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="busnumber" class="form-label">Engine Number</label><br>

                                </span>
                                <input type="text" class="form-control" id="busnumber" name="enumber" required>
                                <span id="error" class="error">
                            </div>
                            <div class="mb-3">
                                <label for="busnumber" class="form-label">Model </label><br>

                                </span>
                                <input type="text" class="form-control" id="busnumber" name="mnumber" required>
                                <span id="error" class="error">
                            </div>
