...
<body>
    ...
    <?php
        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                $customer_exists = exist_customers($conn,$cname,$cphone,$cmail);
                $customer_added = false;
        
                if(!$customer_exists)
                {
                    // Route is unique, proceed
                    $sql = "INSERT INTO `customers` (`customer_name`, `customer_phone`, `customer_mail`,`customer_created`) VALUES ('$cname', '$cphone', '$cmail',current_timestamp());";
            ...
            if(isset($_POST["edit"]))
            {
                ...
                $cmail = $_POST["cmail"];
                $id = $_POST["id"];
                $id_if_customer_exists = exist_customers($conn,$cname,$cphone,$cmail);
                ...
                if(!$id_if_customer_exists || $id == $id_if_customer_exists)
                {
                    ...
                    `customer_mail`='$cmail' WHERE `customers`.`customer_id` = '$id';";
        ...
        data-email="<?php echo $customer_mail; ?>">
    Edit
</button>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addCustomerForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cmail" class="form-label">Customer Email</label>
