        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <address>
                        <strong>GariChapChap TICKET</strong>
                        <br>
                        KENYA
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Booking Amount:</b></em></h4></td>
                    
                            <td class="col-md-6 text-center"><?php echo 'Ksh. ' . $booked_amount; ?></td>
